...
//  test1
//
//  Created by WangHaixin on 11/17/15.
//  Copyright © 2015 WangHaixin. All rights reserved.
//

// for scrollView tutorial: https://www.youtube.com/watch?v=hz9pMw4Y2Lk
...
class ViewImage1 : UIViewController, UIScrollViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate
{
    ...
    {
        //empty
        // add code here to add title in navigation bar
    }
    ...
    //set the image data to imageview
    func imgSetup()
    {
    ...
    /**
     this func is to change image position when changing screen orientation: portrait and landscape
     **/
        ...
        coordinator.animateAlongsideTransition({ (UIViewControllerTransitionCoordinatorContext) -> Void in
            ...
            default:
               // print("Landscape")
                ...
                self.imageView.frame = contentsFrame
                //this is for zooming scale in landscape mode zooming
