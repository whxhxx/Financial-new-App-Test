...
//    @IBOutlet weak var theButton: UIButton!
    ...
    var imgAddress: String?
        ...
        //lind data from Post to cell elements
...
//                }
            ...
            {
                self.textInCell.frame.size.height = 480
                 if post.time != ""
                {
                    ...
                    self.textInCell.attributedText = NSAttributedString(string:self.textInCell.text!, attributes:attributes)
                    self.textInCell.font = UIFont.systemFontOfSize(16)
                }
                else
                {
                    self.textInCell.text = post.postDescription
